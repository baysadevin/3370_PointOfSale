...
-- TRANSACTIONS (10 historical sales)

-- Txn 1: T-Shirt(1) x2, Jeans(2) x1 - CASH
INSERT INTO transactions (employeeID, type, payment_method, subtotal, tax_amount, total, amount_tendered, change_given, returned) VALUES ('001', 'SALE', 'CASH', 89.97, 5.40, 95.37, 100.00, 4.65, 0);
...
-- Txn 2: Sneakers(6) x1, Belt(7) x1 - CARD
INSERT INTO transactions (employeeID, type, payment_method, subtotal, tax_amount, total, amount_tendered, change_given, returned) VALUES ('002', 'SALE', 'CARD', 94.98, 5.70, 100.68, 0, 0, 0);
...
-- Txn 3: Coffee Maker(25) x1, Cutting Board(26) x1 - CASH
INSERT INTO transactions (employeeID, type, payment_method, subtotal, tax_amount, total, amount_tendered, change_given, returned) VALUES ('003', 'SALE', 'CASH', 64.98, 3.90, 68.88, 70.00, 1.10, 0);
...
-- Txn 4: Headphones(32) x1 - CARD
INSERT INTO transactions (employeeID, type, payment_method, subtotal, tax_amount, total, amount_tendered, change_given, returned) VALUES ('004', 'SALE', 'CARD', 79.99, 4.80, 84.79, 0, 0, 0);
INSERT INTO transaction_items (transaction_id, product_id, quantity, unit_price, line_total) VALUES (4, 32, 1, 79.99, 79.99);

-- Txn 5: Bath Towel(16) x2, Pillow(18) x1 - CASH
INSERT INTO transactions (employeeID, type, payment_method, subtotal, tax_amount, total, amount_tendered, change_given, returned) VALUES ('001', 'SALE', 'CASH', 69.97, 4.20, 74.17, 80.00, 5.85, 0);
...
-- Txn 6: Smart Watch(35) x1 - CARD
INSERT INTO transactions (employeeID, type, payment_method, subtotal, tax_amount, total, amount_tendered, change_given, returned) VALUES ('005', 'SALE', 'CARD', 149.99, 9.00, 158.99, 0, 0, 0);
INSERT INTO transaction_items (transaction_id, product_id, quantity, unit_price, line_total) VALUES (6, 35, 1, 149.99, 149.99);

-- Txn 7: Yoga Mat(48) x1, Water Bottle(49) x2 - CASH
INSERT INTO transactions (employeeID, type, payment_method, subtotal, tax_amount, total, amount_tendered, change_given, returned) VALUES ('002', 'SALE', 'CASH', 69.97, 4.20, 74.17, 80.00, 5.85, 0);
...
-- Txn 8: Board Game(56) x1, Stuffed Animal(58) x1 - GIFT_CARD
INSERT INTO transactions (employeeID, type, payment_method, subtotal, tax_amount, total, amount_tendered, change_given, returned) VALUES ('003', 'SALE', 'GIFT_CARD', 49.98, 3.00, 52.98, 0, 0, 0);
...
-- Txn 9: Backpack(62) x1, Wallet(65) x1 - CARD
INSERT INTO transactions (employeeID, type, payment_method, subtotal, tax_amount, total, amount_tendered, change_given, returned) VALUES ('004', 'SALE', 'CARD', 64.98, 3.90, 68.88, 0, 0, 0);
...
-- Txn 10: Hoodie(11) x1, Sweatpants(15) x1, Sneakers(6) x1 - CASH
INSERT INTO transactions (employeeID, type, payment_method, subtotal, tax_amount, total, amount_tendered, change_given, returned) VALUES ('001', 'SALE', 'CASH', 179.97, 10.80, 190.77, 200.00, 9.25, 0);
